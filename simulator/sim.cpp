...
void Simulator::dump_stats()
{
    ...
    printf("Cycles: %llu\n", clock);
    printf("Cache Misses:     %8llu misses\n", cache_misses);
    printf("Cache Accesses:   %8llu accesses\n", cache_accesses);
    printf("Silent Upgrades:  %8llu upgrades\n", silent_upgrades);
    printf("$-to-$ Transfers: %8llu transfers\n", cache_to_cache_transfers);
    printf("Memory Reads:     %8llu reads\n", memory_reads);
    printf("Memory Writes:    %8llu writes\n", memory_writes);
}
